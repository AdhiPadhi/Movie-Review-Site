...
router.route("/new").post(ReviewsCtrl.apiPostReviews); //defining a POST route for the /new path of the reviews API, this route will be used to add a new review for a movie, the ReviewsCtrl.apiPostReviews method will be called to handle the request and send the response
router.route("/:id")
